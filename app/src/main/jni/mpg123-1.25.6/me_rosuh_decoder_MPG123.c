...
JNIEXPORT jint JNICALL me_rosuh_decoder_MPG123_init
	(JNIEnv *env, jclass c)
{
	return mpg123_init();
}
...
/*
JNIEXPORT jlong JNICALL me_rosuh_decoder_MPG123_new
	(JNIEnv *env, jclass c)
{
	int err;
...
JNIEXPORT jstring JNICALL me_rosuh_decoder_MPG123_getErrorMessage
	(JNIEnv *env, jclass c, jint error)
{
	return (*env)->NewStringUTF(env, mpg123_plain_strerror(error));
}

JNIEXPORT jlong JNICALL me_rosuh_decoder_MPG123_openFile
...
JNIEXPORT void JNICALL me_rosuh_decoder_MPG123_delete
...
JNIEXPORT jint JNICALL me_rosuh_decoder_MPG123_readSamples
...
JNIEXPORT jint JNICALL me_rosuh_decoder_MPG123_skipSamples
...
JNIEXPORT jint JNICALL me_rosuh_decoder_MPG123_seek
...
JNIEXPORT float JNICALL me_rosuh_decoder_MPG123_getPosition
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
...
JNIEXPORT jint JNICALL me_rosuh_decoder_MPG123_getNumChannels
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
    return mp3->channels;
...
JNIEXPORT jint JNICALL me_rosuh_decoder_MPG123_getRate
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
    return mp3->rate;
...
JNIEXPORT jlong JNICALL me_rosuh_decoder_MPG123_getNumFrames
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
...
JNIEXPORT jfloat JNICALL me_rosuh_decoder_MPG123_getDuration
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
    return mp3->duration;
...
JNIEXPORT jdouble JNICALL me_rosuh_decoder_MPG123_getSecondsPerFrame
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
...
JNIEXPORT jlong JNICALL me_rosuh_decoder_MPG123_getOutputBlockSize
	(JNIEnv *env, jclass c, jlong handle)
{
    MP3File *mp3 = (MP3File *)handle;
...
JNIEXPORT jintArray JNICALL me_rosuh_decoder_MPG123_getSupportedRates
	(JNIEnv *env, jclass c)
{
	const long *list;
	size_t i, number;
